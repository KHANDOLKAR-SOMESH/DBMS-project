                ...
                <div class="row justify-content-md-center">
                    <div class="col-8">
                        <form class="text-center border border-light p-5" method="post">
                            ...
                            <input name="address" type="text" class="form-control mb-5" placeholder="enter address (h.no,village street,state ,pincode, landmark)" required>
                            <input class="btn btn-primary h" type="submit" value="Place Order" name="orderplace">
                        </form>
                    </div>
                </div>
            </div>
